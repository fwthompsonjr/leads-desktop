namespace LegalLead.Changed.Classes
{
    public class CommandSetInstallVersion : BuildCommandBase
    {
        ...
        //            .ToList().Find(x =>
        //            x.Attributes.GetNamedItem("Property").InnerText.Equals("ProductVersion", StringComparison.CurrentCultureIgnoreCase));
        //        if (node.Attributes.GetNamedItem("Value").InnerText.Equals(LatestVersion.Number, StringComparison.CurrentCultureIgnoreCase))
        //        {
        //            return true;
        //        }
