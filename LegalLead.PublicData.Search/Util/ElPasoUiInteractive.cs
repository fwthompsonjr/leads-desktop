...
{
    internal class ElPasoUiInteractive : BaseUiInteractive
    {
        public ElPasoUiInteractive(WebNavigationParameter parameters) : base(parameters)
        {
            var container = ActionElPasoContainer.GetContainer;
        ...
        {
            return ElPasoCourtLookupService.GetAddress(courtType, court);
        }
            ...
            dates.ForEach(d =>
            {
                ...
                selections.ForEach(sel =>
                {
                    ...
                    common.ForEach(a =>
                    {
                        ...
                        {
                            if (a is ElPasoSetParameters setparms) setparms.ParameterId = id;
