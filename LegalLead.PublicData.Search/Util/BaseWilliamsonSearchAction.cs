...
namespace LegalLead.PublicData.Search.Util
{
    ...
    public class BaseWilliamsonSearchAction : ICountySearchAction
    {
        ...
        private static readonly string _navUri = WilliamsonScriptHelper.GetNavigationUri;
        private static readonly Dictionary<string, string> _collection = WilliamsonScriptHelper.ScriptCollection;
    }
}