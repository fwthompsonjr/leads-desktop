...
namespace LegalLead.PublicData.Search.Util
{
    ...
    public class BaseGraysonSearchAction : ICountySearchAction
    {
        ...
        private static readonly string _navUri = GraysonScriptHelper.GetNavigationUri;
        private static readonly Dictionary<string, string> _collection = GraysonScriptHelper.ScriptCollection;
    }
}