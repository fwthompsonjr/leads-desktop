...
{
    public class BaseGraysonSearchActionTests
    {
        [Fact]
        public void ServiceHasTypeDefined()
        {
            var error = Record.Exception(() => _ = typeof(BaseGraysonSearchAction));
            Assert.Null(error);
        }
        [Fact]
        ...
        private sealed class MockSearchTesting : BaseGraysonSearchAction
        {
