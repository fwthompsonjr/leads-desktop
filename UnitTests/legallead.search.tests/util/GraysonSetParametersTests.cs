...
{
    public class GraysonSetParametersTests
    {
        [Fact]
        public void ComponentHasCorrectOrder()
        {
            const int index = 20;
            var service = new GraysonSetParameters();
        ...
        {
            var service = new MockGraysonSetParameters();
        ...
        private sealed class MockGraysonSetParameters : GraysonSetParameters
        {
