...
{
    public class TravisSetupParametersTests
    {
        [Fact]
        public void ComponentHasCorrectOrder()
        {
            const int index = 30;
            var service = new TravisSetupParameters();
        ...
        public void ComponentCanExecute()
        {
            ...
            var service = new MockTravisSetupParameters
            {
                CourtLocationId = 0,
        ...
        private sealed class MockTravisSetupParameters : TravisSetupParameters
        {
