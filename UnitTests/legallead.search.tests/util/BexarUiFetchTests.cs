...
{
    public class BexarUiFetchTests
    {
        [Theory]
        [InlineData(true)]
        [InlineData(false)]
        ...
        {
            Assert.Throws<ArgumentNullException>(() => { _ = new BexarUiInteractive(null, show); });
        }
        ...
        public void ServiceRequiresValidParameters(int conditionId)
        {
            ...
            Assert.Throws<ArgumentOutOfRangeException>(() => { _ = new BexarUiInteractive(wb); });
        }
        ...
        public void ServiceCanGetDriver(bool show)
        {
            ...
            var keys = new List<WebNavigationKey> {
                ...
                new() { Name = "CourtType", Value = "JUSTICE"} };
            var wb = new WebNavigationParameter { Keys = keys };
            var service = new BexarUiInteractive(wb);
        ...
        public void ServiceCanFetch(int instanceId)
        {
            var error = Record.Exception(() =>
            {
                ...
                var wb = new WebNavigationParameter { Keys = keys };
                BexarUiInteractive service = instanceId switch
                {
        ...
        private sealed class NoIteratingWeb : BexarUiInteractive
        {
        ...
        private sealed class NoIteratingWebWithCancellation : BexarUiInteractive
        {
        ...
        private sealed class NoIteratingWebWithNoData : BexarUiInteractive
        {
        ...
        private sealed class IteratingWeb : BexarUiInteractive
        {
        ...
        private sealed class IterateDate : BexarUiInteractive
        {
        ...
        private sealed class MockIterateItem : BexarUiInteractive
        {
        ...
        private sealed class FakeBexarFetchCaseDetail : BexarFetchCaseDetail
        {
        ...
        private sealed class FakeIntCaseDetail : BexarFetchCaseDetail
        {
            public override object Execute()
            {
                var fkr = new Faker();
