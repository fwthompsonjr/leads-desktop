...
{
    public class BaseHidalgoSearchActionTests
    {
        [Fact]
        public void ServiceHasTypeDefined()
        {
            var error = Record.Exception(() => _ = typeof(BaseHidalgoSearchAction));
            Assert.Null(error);
        }
        [Fact]
        ...
        private sealed class MockSearchTesting : BaseHidalgoSearchAction
        {
