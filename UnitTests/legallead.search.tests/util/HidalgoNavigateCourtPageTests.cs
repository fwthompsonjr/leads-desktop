...
{
    public class HidalgoNavigateCourtPageTests
    {
        [Fact]
        public void ComponentHasCorrectOrder()
        {
            const int index = 15;
            var service = new HidalgoNavigateCourtPage();
        ...
        public void ComponentCanExecute(string locator)
        {
            ...
            var service = new MockHidalgoNavigateCourtPage
            {
        ...
        private sealed class MockHidalgoNavigateCourtPage : HidalgoNavigateCourtPage
        {
