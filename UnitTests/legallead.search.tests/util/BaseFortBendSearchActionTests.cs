...
{
    public class BaseFortBendSearchActionTests
    {
        [Fact]
        public void ServiceHasTypeDefined()
        {
            var error = Record.Exception(() => _ = typeof(BaseFortBendSearchAction));
            Assert.Null(error);
        }
        [Fact]
        ...
        private sealed class MockSearchTesting : BaseFortBendSearchAction
        {
