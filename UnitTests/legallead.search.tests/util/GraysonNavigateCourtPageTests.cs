...
{
    public class GraysonNavigateCourtPageTests
    {
        [Fact]
        public void ComponentHasCorrectOrder()
        {
            const int index = 15;
            var service = new GraysonNavigateCourtPage();
        ...
        public void ComponentCanExecute(string locator)
        {
            ...
            var service = new MockGraysonNavigateCourtPage
            {
        ...
        private sealed class MockGraysonNavigateCourtPage : GraysonNavigateCourtPage
        {
