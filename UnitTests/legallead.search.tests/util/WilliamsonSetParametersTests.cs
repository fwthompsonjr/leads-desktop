...
{
    public class WilliamsonSetParametersTests
    {
        [Fact]
        public void ComponentHasCorrectOrder()
        {
            const int index = 20;
            var service = new WilliamsonSetParameters();
        ...
        {
            var service = new MockWilliamsonSetParameters();
        ...
        private sealed class MockWilliamsonSetParameters : WilliamsonSetParameters
        {
