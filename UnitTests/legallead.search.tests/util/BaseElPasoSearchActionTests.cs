...
{
    public class BaseElPasoSearchActionTests
    {
        [Fact]
        public void ServiceHasTypeDefined()
        {
            var error = Record.Exception(() => _ = typeof(BaseElPasoSearchAction));
            Assert.Null(error);
        }
        [Fact]
        ...
        private sealed class MockSearchTesting : BaseElPasoSearchAction
        {
