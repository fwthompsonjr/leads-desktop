...
{
    public class ParseMatterOfNameChange : ICaseDataParser
    {
        // Name Change of:
        private static readonly string _searchKeyWord = @"in the matter of the change of name of:";
